...
namespace YoutubeExtractor
{
    ...
    /// </summary>
    public class VideoDownloader : Downloader, IDisposable
    {
        ...
        public override void Execute()
        {
            ...
            _request = (HttpWebRequest)WebRequest.Create(this.Video.DownloadUrl);

            if (this.BytesToDownload.HasValue)
            {
                _request.AddRange(0, this.BytesToDownload.Value - 1);
            }
